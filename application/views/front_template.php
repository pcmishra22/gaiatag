  ...
  <body>
    ...
    <header id="header">
      <nav class="navbar navbar-default navbar-fixed-top menu">
        ...
        <?php
          if(!empty($this->session->userdata('email')) && !empty($this->session->userdata('userid')))
          {
        ?>
            <li class="dropdown"><a href="<?php echo base_url();?>users/logout">Logout</a></li>
        <?php
        }
          else
        {
   ...
   <div class="container">
            ...
            <div class="row">
              <div class="col-md-3">
                <div class="profile-info">
                  ...
                  <h3><?php echo $this->session->userdata('firstname');?>
                   &nbsp;<?php echo $this->session->userdata('lastname');?></h3>
    ...
    <script src="<?php echo base_url();?>frontend/js/jquery.sticky-kit.min.js"></script>
    <script src="<?php echo base_url();?>frontend/js/jquery.scrollbar.min.js"></script>
