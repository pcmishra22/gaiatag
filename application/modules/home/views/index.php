...
<html lang="en">
  <head>
    ...
    <!--Favicon-->
    <link rel="shortcut icon" type="image/png" href="<?php echo base_url();?>frontend/images/fav.png"/>
  </head>
  <body>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right main-menu">
              ...
              <li class="dropdown"><a href="<?php echo base_url();?>users/login">Login</a></li>
            </ul>
    ...
    <section id="banner">
      <div class="container">
        ...
        <!--<div class="sign-up-form">
          <a href="index.html" class="logo"><img src="<?php echo base_url();?>frontend/images/logo.png" alt="Friend Finder"/></a>
          ...
          <img class="form-shadow" src="<?php echo base_url();?>frontend/images/bottom-shadow.png" alt="" />
    ...
    <section id="features">
      <div class="container wrapper">
        ...
        <img src="<?php echo base_url();?>frontend/images/face-map.png" alt="" class="img-responsive face-map slideUp hidden-sm hidden-xs" />
      </div>
    ...
    <section id="app-download">
      <div class="container wrapper">
        ...
        <ul class="app-btn list-inline slideUp">
          <li><button class="btn-secondary"><img src="<?php echo base_url();?>frontend/images/app-store.png" alt="App Store" /></button></li>
          <li><button class="btn-secondary"><img src="<?php echo base_url();?>frontend/images/google-play.png" alt="Google Play" /></button></li>
        </ul>
        ...
        <div class="row">
          <div class="footer-wrapper">
            <div class="col-md-3 col-sm-3">
              <a href=""><img src="<?php echo base_url();?>frontend/images/logo-black.png" alt="" class="footer-logo" /></a>
