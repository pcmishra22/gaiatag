                ...
                <div class="pull-right">
                    <ul class="header-btns">
                        ...
                        <li class="header-account dropdown default-dropdown">
                            ...
                            <a href="<?php echo base_url();?>users/login" class="text-uppercase">Login</a> / <a href="<?php echo base_url();?>users/signup" class="text-uppercase">Join</a>
                            <ul class="custom-menu">
                                    ...
                                    <div class="shopping-cart-list">
                                        <div class="product product-widget">
                                            <div class="product-thumb">
                                                <img src="<?php echo base_url();?>front/img/thumb-product01.jpg" alt="">
                                            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                 <?php
                        ...
                        {
                            echo '<div  style="color:red;" align="center" class="alert alert-success"><strong>Account is created successfully !</strong></div>';
                        }
                ...
                <form id="login" name="login" class="clearfix" method="post" action="<?php echo base_url()?>users/loginverify">
                    <div class="col-md-12">
                        <div class="billing-details">
                            <p>Not a customer ? <a href="<?php echo base_url();?>users/signup">Signup</a></p>
                            ...
                            <div class="form-group">
                                ...
                                <button class="primary-btn" name="submit" id="submit">LOGIN</button>
                             </div>
                        </div>
                    </div>
                </form>
