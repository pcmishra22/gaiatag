      ...
      <nav class="navbar navbar-default navbar-fixed-top menu">
        <div class="container">
          ...
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index-register.html"><img src="<?php echo base_url();?>frontend/images/logo.png" alt="logo" /></a>
          </div>
              ...
              <div class="tab-content">
                <div class="tab-pane" id="register">
                    <?php
                        ...
                        if($this->session->flashdata('flash_message') == 'signupsuccess')
                        {
                            echo '<div  style="color:green;" align="center" class="alert alert-success"><strong>Account created successfully !</strong></div>';
                        }
                       ?>
                  <h3>Register Now !!!</h3>
                  ...
                  <!--Register Form-->
                  <form name="registration_form" id='registration_form' class="form-inline" method="post" action="<?php echo base_url();?>users/signup">
                    <div class="row">
                    ...
                    <div class="row">
                      <div class="form-group col-xs-12">
                        ...
                        <input id="confirmpassword" class="form-control input-group-lg" type="password" name="confirmpassword" title="Enter password" placeholder="Confirm Password"/>
                      </div>
                    </div>
                  
                  <p><a href="#login">Already have an account?</a></p>
                  <button class="btn btn-primary" name="submit" id="submit">Register Now</button>
                ...
                <div class="tab-pane active" id="login">
                  ...
                  <!--Login Form-->
                  <form name="Login_form" id='Login_form' method="post" action="<?php echo base_url()?>users/loginverify">
                     <div class="row">
                      <div class="form-group col-xs-12">
                        <label for="email" class="sr-only">Email</label>
                        <input id="email" class="form-control input-group-lg" type="text" name="email" title="Enter Email" placeholder="Your Email"/>
