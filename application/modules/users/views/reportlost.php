                  ...
                  <form name="basicinfo" id="basicinfo" class="form-inline" action="" method="post">
                    ...
                    <div class="row">
                      <div class="form-group col-xs-6">
                       ...
                       <input id="cellphone" class="form-control input-group-lg" type="text" name="createddate" title="Created Date"  value="<?php echo $userdetails['datecreated']?>"/>
                      </div>
                      <div class="form-group col-xs-6">
                        <label for="homephone">Last Updated</label>
                       <input id="homephone" class="form-control input-group-lg" type="text" name="updateddate" title="Last Updated" value="<?php echo $userdetails['editprofile_datetime']?>"/>
                      </div>
                    </div>
