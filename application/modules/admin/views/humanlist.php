 <!-- Content -->
            <div id="content">
                ...
                <div class="wrapper">
                  ...
                  <div class="widget">
                    <div class="navbar"><div class="navbar-inner"><h6>MANAGE USER'S HUMAN LIST :-</h6></div></div>
                        ...
                        <table class="table table-striped table-bordered" id="data-table">
                            ...
                            <tbody>
                              ...
                              foreach($userlist as $user)
                                {
                                     $fullpath=base_url()."human_images/".$user['human_image'];
                                ?>
                                <tr>
                                    <td><?php echo $user['id']?></td>
                                    <td><?php echo $user['userid']?></td>
                                    <td><?php echo $user['human_name']?></td>
                                    <td> <img src="<?php echo $fullpath;?>" alt="<?php echo $user['human_name']?>" width="200px" height="110px" /></td>
                                    <td><?php echo $user['human_type']?></td>
                                    <td><?php echo $user['vet_name']?></td>
