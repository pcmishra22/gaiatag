 <!-- Content -->
            <div id="content">
                ...
                <div class="wrapper">
                  ...
                  <div class="widget">
                    <div class="navbar"><div class="navbar-inner"><h6>MANAGE EMAIL TEMPLATE LIST :-</h6></div></div>
                            ...
                            <tbody>
                              ...
                              foreach($userlist as $user)
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $user['template_name']?></td>
                                    <td><?php echo $user['template_contents']?></td>
